...
<head>
    ...
    <title>Certificate Verification | CertPro</title>
...
<!-- Navbar (same as main certifications page) -->
...
<main class="verifier-main">
    <div class="container">
        ...
        <h1>Certificate Verification <span class="text-gradient">Portal</span></h1>
...
<!-- Footer (same as main certifications page) -->
